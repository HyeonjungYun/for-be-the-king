...
| `combat-system.md` | #7 전투 시스템 | **중간** | 공식 5/6·규칙 6/8·엣지 14/16 생존. 🔴 **파손 요인 3개** — **GAS 전역 참조 7곳 전부 무효**(미채택 확정 08-11, 서버 C++ 권위+공유 데이터 테이블로 대체) · D4→저항력 스탯 교체 · **"성장" 소실로 상수 재검증**(맨몸 기본 스탯 확정됨). 상세는 `active.md` |
