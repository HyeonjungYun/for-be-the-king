# Unreal Engine 5.7 (미재검증) — Navigation Module Reference

> ⚠️ **검증 상태 — 2026-08-10**
> 이 문서의 내용은 **UE 5.7 시점에 작성**되었고 5.8 기준으로 재검증되지 않았습니다.
> 프로젝트 고정 버전은 **5.8.1** 입니다. 참고는 하되, API를 쓰기 전에 반드시 확인하세요.
>
> ```bash
> grep -rn "API명" /c/Unreal5.8/UE_5.8/Engine/Source/Runtime --include=*.h
> ```
>
> 5.8 기준으로 검증된 문서: `VERSION.md` · `deprecated-apis.md` · `breaking-changes.md` · `modules/networking.md`
